...
(custom-set-variables
 ...
 '(default-frame-alist (quote ((alpha . 90) (left-fringe . 4) (right-fringe . 4))))
 '(display-time-mode t)
 '(fci-rule-color "#383838")
 '(graphviz-dot-preview-extension "pdf")
 '(mouse-drag-copy-region t)
 '(org-agenda-files (quote ("~/Dropbox/Note/todo.org" "~/Dropbox/Note/main.org" "~/Dropbox/Note/index.org")))
 '(org-todo-keywords (quote ((sequence "TODO" "DONE" "WAITING"))))
