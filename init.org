...
*** DONE WindowsでCtrl-Oで<M-kanji>がないとおこられる
*** DONE WindowsでF1がのどかとかち合う
* 標準設定
...
| 説明                             | 変数名                 | 推奨                             |
|----------------------------------+------------------------+----------------------------------|
| CaptureしたOrgファイルを置く場所 | org-directory          | "~/Dropbox/Org"                  |
|                                  | org-default-notes-file | "notes.org"                      |
| キャプチャ                       | org-capture-templates  | t: Todo j: Journal               |
|                                  | org-agenda-files       | todo.org, journal.org, notes.org |
...
| 説明                               | 変数名                    | 推奨                             |
|------------------------------------+---------------------------+----------------------------------|
| Mobile用Orgファイルを置く場所      | org-mobile-directory      | "~/Dropbox/アプリ/MobileOrg"     |
| Mobileで追加した項目を置くファイル | org-mobile-inbox-for-pull | "from-mobile.org"                |
...
*** Shellのコードの実行にbashを使う
   ...
   - <2014-01-24 金>現在，customizationの対応ではない模様．
